...
from build_particles import distributions as dists
...
class Bootstrap(build_particles.FeynmanKac):
...
class DiscreteCox(StateSpaceModel):
    ...
    def PX0(self):
        return dists.Normal(loc=self.mu, scale=self.sigma / np.sqrt(1.0 - self.phi**2))
